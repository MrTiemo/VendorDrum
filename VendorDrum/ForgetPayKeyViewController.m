...
@interface ForgetPayKeyViewController ()<UITextFieldDelegate>
...
@implementation ForgetPayKeyViewController
...
-(void)goNext{
    ...
    [self.navigationController pushViewController:[NSClassFromString(@"PayKeyChangeViewController")new] animated:YES];
}
