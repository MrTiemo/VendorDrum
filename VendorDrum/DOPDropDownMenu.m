...
- (void)setDataSource:(id<DOPDropDownMenuDataSource>)dataSource {
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        CALayer *bgLayer = [self createBgLayerWithColor:[UIColor colorWithRed:0.94 green:0.94 blue:0.96 alpha:1.00] andPosition:bgLayerPosition];
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    self = [self initWithFrame:CGRectMake(origin.x, origin.y, DEVICEWIDTH/3, height)];
    if (self) {
        _origin = origin;
...
- (void)menuTapped:(UITapGestureRecognizer *)paramSender {
    ...
    if (tapIndex == _currentSelectedMenudIndex && _show) {
        ...
        [(CALayer *)self.bgLayers[tapIndex] setBackgroundColor:[UIColor colorWithRed:0.94 green:0.94 blue:0.96 alpha:1.00].CGColor];
    } else {
        _currentSelectedMenudIndex = tapIndex;
...
- (void)backgroundTapped:(UITapGestureRecognizer *)paramSender
{
    ...
    [(CALayer *)self.bgLayers[_currentSelectedMenudIndex] setBackgroundColor:[UIColor colorWithRed:0.94 green:0.94 blue:0.96 alpha:1.00].CGColor];
}
