...
@interface HistoryAddressController ()<UITableViewDelegate,UITableViewDataSource,addHisNewDele>
@property (strong ,nonatomic )UITableView *tableView;
@property (strong ,nonatomic )NSMutableArray *array;
@end
@implementation HistoryAddressController
@synthesize deleHis =_deleHis;
...
- (void)viewDidLoad {
    ...
    //设置按钮
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"add"] style:UIBarButtonItemStyleDone target:self action:@selector(addressAdd)];
...
//新建地址
-(void)addressAdd{
    HistoryNewViewController *newa = [[HistoryNewViewController alloc] init];
    newa.deleNew = self;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.deleHis GetbackHisadd:[_array objectAtIndex:indexPath.row]];
