...
-(UILabel *)labShouHou{
    if (_labShouHou==nil) {
        _labShouHou = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, DEVICEWIDTH-40, 20)];
        _labShouHou.font = labelFontStyle;
        [self addSubview:_labShouHou];
    }
    return _labShouHou;
}
-(UILabel *)labReason{
...
-(UILabel *)labTuiPrice{
    if (_labTuiPrice==nil) {
        ...
        _labTuiPrice.textColor = [UIColor grayColor];
...
-(UILabel *)labShuoMing{
    if (_labShuoMing==nil) {
        _labShuoMing = [[UILabel alloc] initWithFrame:CGRectMake(20, 70, DEVICEWIDTH-40, 40)];
        _labShuoMing.font = labelFontStyle;
        _labShuoMing.textColor = [UIColor grayColor];
        _labShuoMing.numberOfLines = 0;
        [self addSubview:_labShuoMing];
    }
    return _labShuoMing;
}
...
-(UIButton *)btnXiuGai{
    if (_btnXiuGai==nil) {
        _btnXiuGai = [[UIButton alloc] initWithFrame:CGRectMake(DEVICEWIDTH-100, 160, 80, 30)];
