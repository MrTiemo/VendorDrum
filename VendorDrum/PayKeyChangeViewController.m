...
#import "PayKeyChangeViewController.h"

@interface PayKeyChangeViewController ()<UITextFieldDelegate>
...
@implementation PayKeyChangeViewController
...
- (void)viewDidLoad {
    ...
    _textPass.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"密码(6位数字)" attributes:@{NSForegroundColorAttributeName: color}];
