...
@property (nonatomic,strong)UILabel *labShouHou; ///<售后方式

@property (nonatomic,strong)UILabel *labReason; ///<售后原因

@property (nonatomic,strong)UILabel *labTuiPrice; ///<售后金额

@property (nonatomic,strong)UILabel *labShuoMing; ///<售后说明

@property (nonatomic,strong)UIButton *btnXiuGai; ///<修改按钮
